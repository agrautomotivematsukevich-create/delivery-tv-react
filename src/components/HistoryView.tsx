                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 text-sm text-white/50 mt-1">
                        ...
                        {task.status === 'DONE' && task.duration && (
                           <span className="text-accent-green font-bold text-xs border border-accent-green/20 bg-accent-green/5 px-1.5 rounded">{task.duration}</span>
                        )}
                      </div>
                    </div>
                 </div>
                 ...
                 <div className="space-y-6">
                    <div className="bg-white/5 rounded-2xl p-5 border border-white/5">
                       ...
                       <div className="space-y-3">
                          ...
                          <div className="flex justify-between">
                            <span className="text-white/50 flex items-center gap-2"><Clock size={14}/> Duration</span>
                            <span className="font-mono text-accent-green font-bold">{selectedTask.duration || '-'}</span>
                          </div>
                          <div className="flex justify-between">
                    ...
                    <div className="bg-white/5 rounded-2xl p-5 border border-white/5">
                       ...
                       <div className="grid grid-cols-2 gap-3">
                          {[
                            ...
                            { title: t.lbl_photo_inspection, url: selectedTask.photo_inspect }
                          ].map((p, i) => (
                             p.url && (
                               <div 
                                 key={i} 
                          ...
                          {(!selectedTask.photo_gen && !selectedTask.photo_seal && !selectedTask.photo_empty && !selectedTask.photo_inspect) && (
