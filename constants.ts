...
export const TRANSLATIONS: Record<Lang, TranslationSet> = {
  RU: {
    ...
    lbl_photo1: "Общее фото (Сзади)",
    lbl_photo2: "Фото пломбы",
    lbl_photo_empty: "Фото пустого",
    ...
    btn_reg: "Отправить",
    btn_cancel: "Отмена",
    issue_title: "Сообщить о проблеме",
    issue_desc_ph: "Опишите проблему...",
    issue_btn: "Отправить проблему",
    issue_upload: "Добавить фото",
    issue_success: "Проблема отправлена",
    btn_history: "История проблем",
    history_title: "История",
    history_empty: "Проблем не найдено",
    history_back: "Назад к списку",
  ...
  EN_CN: {
    ...
    next: "NEXT / 下一个",
    list: "ACTIVE TASKS / 任务",
    lunch: "LUNCH BREAK / 午休",
    victory: "COMPLETED! / 完成",
    status_active: "ACTIVE / 运行",
    status_pause: "PAUSED / 暂停",
    status_wait: "WAITING / 等待",
    eta_prefix: "ETA / 预计: ",
    ...
    stat_done: "DONE / 完成",
    stat_queue: "QUEUE / 排队",
    list_done: "UNLOADED / 已卸载",
    list_wait: "QUEUE / 等待中",
    drv_title: "Terminal / 终端",
    btn_login: "Login / 登录",
    btn_start: "START / 开始",
    btn_finish: "FINISH / 完成",
    lbl_photo1: "General Photo / 照片",
    lbl_photo2: "Seal Photo / 封条",
    lbl_photo_empty: "Empty Photo / 空箱",
    msg_uploading: "Uploading... / 上传中",
    msg_success: "Success! / 成功",
    login_title: "Login / 登录",
    reg_title: "Register / 注册",
    empty: "No tasks / 无任务",
    btn_reg: "Send / 发送",
    btn_cancel: "Cancel / 取消",
    issue_title: "Report Issue / 报告问题",
    issue_desc_ph: "Describe the issue... / 描述问题",
    issue_btn: "Submit Issue / 提交",
    issue_upload: "Add Photo / 添加照片",
    issue_success: "Report sent / 发送成功",
    btn_history: "Issue History / 问题记录",
    history_title: "History / 历史",
    history_empty: "No issues found / 无记录",
    history_back: "Back / 返回",
