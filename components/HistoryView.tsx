...
import { Calendar, Package, X, ChevronLeft, ChevronRight } from 'lucide-react';
...
const HistoryView: React.FC<HistoryViewProps> = ({ t }) => {
  ...
  return (
    <div className="flex flex-col gap-6 h-full flex-1 min-h-0">
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 gap-8">
                <div className="space-y-4">
                  ...
                  {(() => {
                    const images = [selectedTask.photo_gen, selectedTask.photo_seal, selectedTask.photo_empty].filter((url): url is string => Boolean(url));
                    return (
      ...
      {lightbox && (
        <div className="fixed inset-0 z-[100] bg-black flex items-center justify-center p-4" onClick={() => setLightbox(null)}>
          <button
            onClick={(e) => {
              e.stopPropagation();
          ...
          <div onClick={(e) => e.stopPropagation()} className="max-w-full max-h-full">
            <SecureImage src={lightbox.images[lightbox.index]} alt="Full task image" className="max-w-full max-h-[90vh] object-contain shadow-2xl" />
