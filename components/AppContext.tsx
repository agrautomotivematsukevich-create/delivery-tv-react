...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const setUser = (newUser: User | null) => {
    ...
    if (newUser) localStorage.setItem('warehouse_user', JSON.stringify(newUser));
    else localStorage.removeItem('warehouse_user');
  };
  ...
  return (
    <AppContext.Provider value={{ user, setUser, dashboardData, setDashboardData, isOffline, setIsOffline, toasts, addToast, removeToast, confirm, lang, setLang }}>
      {children}
